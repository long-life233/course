...
<img src="https://static01.imgkr.com/temp/509af5e44e654c64b868b155ea890a81.png" />
...
| 字符组 | 匹配一个字符，可以是多种可能之一，比如[0-9],标识匹配一个数字。也有\d的简写形式。另外还有反义字符组，表示可以是除了特定字符之外任何一个字符，比如[^0-9]，表示一个非数字字符，也有\D的简写形式。|
